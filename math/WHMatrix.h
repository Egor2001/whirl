...
namespace whirl {
    ...
    WHMatrix3x3 mul(const WHMatrix3x3&, const WHMatrix3x3&);
    WHVector3   mul(const WHVector3&,   const WHMatrix3x3&);

    WHMatrix3x3 triangle(const WHMatrix3x3&);
    
    float       det(const WHMatrix3x3&);
    WHMatrix3x3 inv(const WHMatrix3x3&);
